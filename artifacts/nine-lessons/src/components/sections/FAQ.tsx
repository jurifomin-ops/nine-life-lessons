...
const faqs = [
  ...
  },
  {
    ...
    a: "Программа не фокусируется на теории устройства психики. Она даёт сугубо практические методики и схемы анализа ситуаций, помогающие принимать решения и осмыслять происходящее здесь и сейчас.",
  },
  {
    q: "Это безопасно для детей?",
    a: "Да. Программа построена на принципах безопасности: мы не оцениваем личность, не обращаемся к травмам и защищаем право подростка не рассказывать о личном, если он этого не хочет.",
  },
  {
    q: "Нужна ли специальная подготовка ведущего?",
    a: "Да, для ведения программы необходимо ознакомиться с методологией и пройти небольшую подготовку, чтобы понимать границы применимости инструментов и соблюдать этику работы с группой.",
  },
  {
  ...
  },
  {
    ...
    a: "Полностью разработан первый модуль. Сейчас мы находимся на стадии экспертной оценки и поиска площадок для проведения микропилота (лето 2026).",
  },
  {
